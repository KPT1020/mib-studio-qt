...
| `SyringePumpSettingsDialog` | Per-pump COM port, baud, Modbus address, syringe volume/unit, adjustable inner diameter, target volume, and "run until stall" auto-restart toggle | [[SyringePumpTab]] |
